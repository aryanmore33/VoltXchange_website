...
import {Chart as ChartJS,CategoryScale,LinearScale,PointElement,LineElement,Title,Tooltip,Legend,Filler,SubTitle,} from "chart.js";
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <div className="space-y-3">
                <button className="w-full bg-black text-black py-2 rounded-lg">Buy Energy</button>
                <button className="w-full bg-gray-100 text-black py-2 rounded-lg">Sell Energy</button>
